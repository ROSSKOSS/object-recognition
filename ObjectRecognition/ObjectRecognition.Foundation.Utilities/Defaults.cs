namespace ObjectRecognition.Foundation.Utilities
{
    public struct Defaults
    {
        public struct RoundButton
        {
            public const string Color = "#FF0049B0";
            public const string EnterColor = "#04347C";
            public const string DownColor = "#2684FF";
